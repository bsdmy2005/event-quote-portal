          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Create New Agency</h2>
                  <p className="text-gray-600">Add a new event agency to the platform</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <Card className="border-0 shadow-sm bg-white">
              <CardHeader className="pb-6">
                ...
                <CardDescription className="text-gray-600">
                  Enter the agency information and contact details
                </CardDescription>
              </CardHeader>
              <CardContent>
                <CreateAgencyForm categories={categories || []} />
              </CardContent>
            </Card>
          </div>
        </main>
