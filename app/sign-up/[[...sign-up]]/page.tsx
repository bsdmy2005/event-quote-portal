    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Join Quote Portal</h1>
          <p className="text-slate-600 mb-4">Create your account to get started</p>
        ...
        <SignUp 
          ...
          appearance={{
            elements: {
              ...
              socialButtonsBlockButton: "border-slate-200 hover:bg-slate-100",
