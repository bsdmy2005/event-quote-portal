...
import { getMySubmissionsAction } from "@/actions/rfq-submissions-actions"
...
export default async function QuotationsPage() {
  ...
  const quotations: any[] = submissionsResult.isSuccess ? (submissionsResult.data || []).map((s: any) => ({
    id: s.id,
    rfqTitle: s.proposalTitle || "Submission",
    agencyName: "Agency",
    status: s.submissionStatus,
    submittedAt: s.submittedAt,
    fileName: s.documents?.[0]?.fileName || "N/A",
    fileSize: s.documents?.[0]?.fileSize || 0,
    notes: s.proposalNotes,
