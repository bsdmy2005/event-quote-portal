    ...
    <div className="w-64 bg-white border-r border-slate-200 flex flex-col shadow-sm">
      ...
      <div className="p-6 border-b border-slate-200">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-600">Event Portal</p>
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 p-4 space-y-1">
        ...
        >
          ...
          <Badge variant="secondary" className="ml-auto bg-slate-100 text-slate-700 text-xs font-medium px-2 py-0.5">
            {categoriesCount}
          </Badge>
        </Link>
      ...
      <div className="p-4 border-t border-slate-200">
        <div className="flex items-center space-x-3 p-3 bg-slate-100 rounded-lg">
          ...
          <div>
            ...
            <p className="text-xs text-slate-600">admin@eventportal.com</p>
          </div>
        </div>
      </div>
    </div>
